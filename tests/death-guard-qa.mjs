...
check('all five style layers are linked',cssFiles.every(file=>html.includes('href="./'+file+(file==='styles/content.css'?'?v=16':file==='styles/popups.css'?'?v=14':'?v=9')+'"')));
