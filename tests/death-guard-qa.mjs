...
check('all five style layers are linked',cssFiles.every(file=>html.includes('href="./'+file+(file==='styles/content.css'?'?v=25':file==='styles/popups.css'?'?v=15':file==='styles/navigation.css'?'?v=11':file==='styles/tokens.css'?'?v=10':'?v=9')+'"')));
