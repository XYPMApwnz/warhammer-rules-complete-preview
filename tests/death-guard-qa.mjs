...
check('all five style layers are linked',cssFiles.every(file=>html.includes('href="./'+file+(file==='styles/content.css'?'?v=18':file==='styles/popups.css'?'?v=15':file==='styles/navigation.css'?'?v=10':'?v=9')+'"')));
...
check('safe mobile controls activate on touch-down',navigation.includes("this.menuButton.addEventListener('touchstart'")&&popups.includes("close.addEventListener('touchstart'"));
