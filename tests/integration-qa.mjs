...
check('owned Enhancements are derived without mutating Army Book data',read('books/death-guard/reader.html').includes('roster-enhancements.js?v=2')&&['furnace','critical-hit-5','melee-a-2','plague-wind-range-12','narthecium-d3','mobile'].every(effect=>read('books/shared/roster-enhancements.js').includes(`item.effect === '${effect}'`)));
