...
const books={
  ...
  'core-rules':{version:null,reader:'reader/index.html',rootPrefix:'../../../',libraryEntry:'reader/index.html',versions:{'app.js':'2','reader/styles.css':'7','reader/app.js':'10'},app:'app.js',usesPopupGlossary:false,files:['styles.css','config.js','basic-content.js','app.js','content/core-rules.source.en.js','content/core-rules.en.js','reader/index.html','reader/search-index.json','reader/styles.css','reader/app.js']},
...
check('shared datasheet design is loaded and precached',['death-guard','adeptus-mechanicus'].every(slug=>bookHtml(slug).includes('href="../shared/datasheet-system.css?v=5"'))&&sw.includes('"./books/shared/datasheet-system.css?v=5"'));
