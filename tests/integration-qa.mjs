...
const books={
  'death-guard':{version:'9',reader:'reader.html',versions:{'styles/tokens.css':'10','styles/navigation.css':'10','styles/content.css':'24','styles/popups.css':'15','scripts/roster-filter.js':'12','scripts/navigation-controller.js':'15','scripts/popup-controller.js':'21','scripts/full-entry-controller.js':'7','scripts/journey-controller.js':'11','scripts/ui-controllers.js':'11','scripts/related-rules.js':'6','scripts/app.js':'25'},app:'scripts/app.js',usesPopupGlossary:true,files:['assets/icon-v4.svg','styles/tokens.css','styles/layout.css','styles/navigation.css','styles/content.css','styles/popups.css','scripts/roster-filter.js','scripts/navigation-controller.js','scripts/popup-controller.js','scripts/full-entry-controller.js','scripts/journey-controller.js','scripts/ui-controllers.js','scripts/related-rules.js','scripts/app.js']},
  'core-rules':{version:null,reader:'reader/index.html',rootPrefix:'../../../',libraryEntry:'reader/index.html',versions:{'app.js':'1','reader/styles.css':'5','reader/app.js':'5'},app:'app.js',usesPopupGlossary:false,files:['styles.css','config.js','basic-content.js','app.js','content/core-rules.source.en.js','content/core-rules.en.js','reader/index.html','reader/search-index.json','reader/styles.css','reader/app.js']},
...
for(const file of ['service-worker.js','books/shared/navigation-targets.js','books/shared/datasheet-layout.js','books/shared/popup-content.js','books/shared/roster-entities.js',...Object.entries(books).map(([slug,book])=>`books/${slug}/${book.app}`)]){
...
check('Mega Glossary return UI is versioned and precached',read('glossary/index.html').includes('id="libraryBack"')&&read('glossary/index.html').includes('viewer.js?v=4')&&sw.includes('"./glossary/viewer.js?v=4"')&&sw.includes('"./glossary/viewer-popup.css?v=1"'));
