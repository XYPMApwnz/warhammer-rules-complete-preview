...
check('Mega Glossary return UI is shared, versioned and precached',read('glossary/index.html').includes('id="libraryBack"')&&read('glossary/index.html').includes('../glossary-return.js?v=1')&&read('glossary/index.html').includes('viewer.js?v=7')&&sw.includes('"./glossary-return.js?v=1"')&&sw.includes('"./glossary/viewer.js?v=7"')&&sw.includes('"./glossary/viewer-progressive.css?v=1"'));
