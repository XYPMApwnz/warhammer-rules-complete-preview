...
const books={
  'death-guard':{version:'9',reader:'reader.html',versions:{'styles/tokens.css':'10','styles/navigation.css':'11','styles/content.css':'28','styles/popups.css':'17','scripts/roster-filter.js':'14','scripts/navigation-controller.js':'15','scripts/popup-controller.js':'24','scripts/full-entry-controller.js':'8','scripts/journey-controller.js':'12','scripts/ui-controllers.js':'11','scripts/related-rules.js':'6','scripts/app.js':'30'},app:'scripts/app.js',usesPopupGlossary:true,files:['assets/icon-v4.svg','styles/tokens.css','styles/layout.css','styles/navigation.css','styles/content.css','styles/popups.css','scripts/roster-filter.js','scripts/navigation-controller.js','scripts/popup-controller.js','scripts/full-entry-controller.js','scripts/journey-controller.js','scripts/ui-controllers.js','scripts/related-rules.js','scripts/app.js']},
  ...
  'adeptus-mechanicus':{version:'1',versions:{'styles/tokens.css':'13','styles/layout.css':'14','styles/navigation.css':'13','styles/content.css':'15','styles/popups.css':'16','styles/mechanicus.css':'15','scripts/popup-controller.js':'21','scripts/journey-controller.js':'2','scripts/related-rules.js':'3','scripts/roster-enhancements.js':'2','scripts/roster-filter.js':'2','scripts/app.js':'22'},app:'scripts/app.js',usesPopupGlossary:true,files:['assets/mechanicus-logo.png','assets/mechanicus-cover-800.webp','styles/tokens.css','styles/layout.css','styles/navigation.css','styles/content.css','styles/popups.css','styles/mechanicus.css','scripts/data.js','scripts/navigation-controller.js','scripts/popup-controller.js','scripts/journey-controller.js','scripts/ui-controllers.js','scripts/related-rules.js','scripts/roster-enhancements.js','scripts/roster-filter.js','scripts/app.js']}
};
...
check('Mechanicus records open the real responsive reader',rosterGuides.includes('Death Guard and Adeptus Mechanicus exports are recognised')&&rosterGuidesApp.includes("'adeptus mechanicus':'../books/adeptus-mechanicus/index.html'")&&read('books/adeptus-mechanicus/index.html').includes('scripts/roster-filter.js?v=2'));
