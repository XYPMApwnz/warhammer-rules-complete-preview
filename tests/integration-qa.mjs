...
const books={
  ...
  'core-rules':{version:null,reader:'reader/index.html',rootPrefix:'../../../',libraryEntry:'reader/index.html',versions:{'reader/styles.css':'14','reader/app.js':'12'},app:'reader/app.js',usesPopupGlossary:false,files:['reader/index.html','reader/search-index.json','reader/styles.css','reader/app.js']},
  'adeptus-mechanicus':{version:'1',versions:{'styles/tokens.css':'13','styles/layout.css':'14','styles/navigation.css':'13','styles/content.css':'15','styles/popups.css':'16','styles/mechanicus.css':'14','scripts/popup-controller.js':'20','scripts/related-rules.js':'2','scripts/roster-enhancements.js':'2','scripts/roster-filter.js':'2','scripts/app.js':'20'},app:'scripts/app.js',usesPopupGlossary:true,files:['assets/mechanicus-logo.png','assets/mechanicus-cover-800.webp','styles/tokens.css','styles/layout.css','styles/navigation.css','styles/content.css','styles/popups.css','styles/mechanicus.css','scripts/data.js','scripts/navigation-controller.js','scripts/popup-controller.js','scripts/journey-controller.js','scripts/ui-controllers.js','scripts/related-rules.js','scripts/roster-enhancements.js','scripts/roster-filter.js','scripts/app.js']}
};
