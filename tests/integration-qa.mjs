...
const books={
  'death-guard':{version:'9',reader:'reader.html',versions:{'styles/tokens.css':'10','styles/navigation.css':'11','styles/content.css':'27','styles/popups.css':'16','scripts/roster-filter.js':'14','scripts/navigation-controller.js':'15','scripts/popup-controller.js':'22','scripts/full-entry-controller.js':'8','scripts/journey-controller.js':'11','scripts/ui-controllers.js':'11','scripts/related-rules.js':'6','scripts/app.js':'27'},app:'scripts/app.js',usesPopupGlossary:true,files:['assets/icon-v4.svg','styles/tokens.css','styles/layout.css','styles/navigation.css','styles/content.css','styles/popups.css','scripts/roster-filter.js','scripts/navigation-controller.js','scripts/popup-controller.js','scripts/full-entry-controller.js','scripts/journey-controller.js','scripts/ui-controllers.js','scripts/related-rules.js','scripts/app.js']},
  'core-rules':{version:null,reader:'reader/index.html',rootPrefix:'../../../',libraryEntry:'reader/index.html',versions:{'app.js':'2','reader/styles.css':'7','reader/app.js':'9'},app:'app.js',usesPopupGlossary:false,files:['styles.css','config.js','basic-content.js','app.js','content/core-rules.source.en.js','content/core-rules.en.js','reader/index.html','reader/search-index.json','reader/styles.css','reader/app.js']},
...
check('Mega Glossary return UI is shared, versioned and precached',read('glossary/index.html').includes('id="libraryBack"')&&read('glossary/index.html').includes('../glossary-return.js?v=1')&&read('glossary/index.html').includes('viewer.js?v=7')&&sw.includes('"./glossary-return.js?v=1"')&&sw.includes('"./glossary/viewer.js?v=7"')&&sw.includes('"./glossary/viewer-progressive.css?v=2"'));
