...
const books={
  ...
  'core-rules':{version:null,reader:'reader/index.html',rootPrefix:'../../../',libraryEntry:'reader/index.html',versions:{'app.js':'2','reader/styles.css':'9','reader/app.js':'10'},app:'app.js',usesPopupGlossary:false,files:['styles.css','config.js','basic-content.js','app.js','content/core-rules.source.en.js','content/core-rules.en.js','reader/index.html','reader/search-index.json','reader/styles.css','reader/app.js']},
