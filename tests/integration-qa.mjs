...
const books={
  ...
  'core-rules':{version:null,reader:'reader/index.html',rootPrefix:'../../../',libraryEntry:'reader/index.html',versions:{'reader/styles.css':'10','reader/app.js':'10'},app:'reader/app.js',usesPopupGlossary:false,files:['reader/index.html','reader/search-index.json','reader/styles.css','reader/app.js']},
