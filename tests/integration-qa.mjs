...
const books={
  'death-guard':{version:'9',versions:{'styles/content.css':'10','styles/popups.css':'11','scripts/popup-controller.js':'14','scripts/app.js':'13'},app:'scripts/app.js',usesPopupGlossary:true,files:['assets/icon-v4.svg','styles/tokens.css','styles/layout.css','styles/navigation.css','styles/content.css','styles/popups.css','scripts/data.js','scripts/navigation-controller.js','scripts/popup-controller.js','scripts/journey-controller.js','scripts/ui-controllers.js','scripts/app.js']},
