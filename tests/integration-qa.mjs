...
check('Mechanicus Phone Mode contains every canonical route',exists('books/adeptus-mechanicus/mobile/index.html')&&fs.readdirSync(path.join(root,'books','adeptus-mechanicus','mobile')).filter(name=>name.endsWith('.html')).length===52);
