(function () {
  'use strict';
  window.CORE_LEARN_MODULES=Object.freeze([
    {id:'introduction',title:'Introduction',sections:['introduction']},
    {id:'basic-rules',title:'Basic Rules',sections:['core-concepts','datasheets','moving','making-attacks','attack-sequence','other-concepts']},
