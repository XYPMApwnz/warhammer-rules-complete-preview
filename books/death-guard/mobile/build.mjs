...
<head>
  ...
  <link rel="stylesheet" href="../styles/content.css?v=25">
...
<body>
  ...
  <script src="../../shared/roster-parser.js?v=1"></script>
  <script src="../../../roster-guides/points-data.js?v=2"></script>
  <script src="../../shared/roster-enhancements.js?v=1"></script>
  <script src="./mobile.js?v=11"></script>
</body>
</html>`;
}
