...
- При ручной прокрутке новый кандидат становится активным только после непрерывного нахождения у контрольной линии не менее 90 ms. Однокадровые промежуточные родители и соседние пункты не должны менять active-state.
