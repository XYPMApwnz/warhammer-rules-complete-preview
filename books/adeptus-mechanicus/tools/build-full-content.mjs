...
<section class="hero section surface am-hero" id="start" data-track="start"><div class="hero-content"><div class="eyebrow">11th Edition // 10 Detachments // ${rules.datasheets.length} Datasheets</div><h1>Flesh fails.<br><em>The Machine endures.</em></h1><p>Adeptus Mechanicus rules reference with current points, roster filtering and official Faction Pack replacements.</p><div class="source">Official Faction Pack v1.0 · current Codex layer from pinned 11e community data</div></div><div class="hero-mark"><img src="./assets/mechanicus-logo.png" width="512" height="512" alt="Adeptus Mechanicus emblem"><span>THE OMNISSIAH KNOWS ALL</span></div></section>
